...
export default function WholesaleEnquiry() {
  ...
  return (
    <section id="wholesale" className="bg-forest py-20 text-ivory sm:py-28">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-8">
        ...
        <motion.form
          ...
          viewport={{ once: true, amount: 0.3 }}
          transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] as const }}
          className="rounded-2xl border border-gold/20 bg-ink/40 p-6 backdrop-blur sm:p-8"
        >
          <div className="grid gap-4">
            <div className="grid gap-1.5">
              ...
              <Input
                ...
                autoComplete="name"
                className="border-gold/25 bg-white/5 text-ivory placeholder:text-ivory/40"
              />
            </div>
            ...
            <div className="grid gap-1.5">
              ...
              <select
                ...
                className="h-9 rounded-lg border border-gold/25 bg-white/5 px-3 text-sm text-ivory outline-none focus-visible:border-gold focus-visible:ring-3 focus-visible:ring-gold/30"
              >
                {collections.map((c) => (
            ...
            <Button
              type="submit"
              size="lg"
              className="mt-2 h-12 w-full px-6 text-base bg-gold text-ink hover:bg-gold-soft"
            >
